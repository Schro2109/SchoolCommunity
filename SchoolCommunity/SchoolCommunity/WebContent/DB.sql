...
--홈 게시판 내용 출력
SELECT PTYPE,TITLE,SUGGESTION,COUNT(Y.CMCODE) COMMENTCOUNT
FROM POST_TBL X LEFT OUTER JOIN COMMENT_TBL Y ON(X.PCODE=Y.PCODE)
GROUP BY PTYPE,TITLE,SUGGESTION
